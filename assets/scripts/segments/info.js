...
const SPRITE_DEFS = {
  ...
  'markings--ground': { id: 'markings--ground', width: 5, offsetY: 11.12 },
  ...
  'ground--rock-brick': { id: 'ground--rock-brick', width: 10, offsetY: 11.25 },
  'ground--red-brick': { id: 'ground--red-brick', width: 10, offsetY: 11.25 },
  'ground--river-water': { id: 'ground--river-water', width: 10, offsetY: 11.25 },
  'ground--grass-rock': { id: 'ground--grass-rock', width: 10, offsetY: 11.25 },
  'ground--river': { id: 'ground--river', width: 10, offsetY: 11.25 },
